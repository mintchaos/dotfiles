...
const float TRAIL_SIZE = 0.85; // 0.0 = all corners move together. 1.0 = max smear (leading corners jump instantly)
const float THRESHOLD_MIN_DISTANCE = 2; // min distance to show trail (units of cursor height)
...
const float TRAIL_THICKNESS_X = 0.8;

const float FADE_ENABLED = 0.5; // 1.0 to enable fade gradient along the trail, 0.0 to disable
